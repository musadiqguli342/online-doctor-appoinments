...
//         return (
//           ruleDate.getFullYear() === bookingDate.getFullYear() &&
//           ruleDate.getMonth() === bookingDate.getMonth() &&
//           ruleDate.getDate() === bookingDate.getDate()
//         );
//       }
...
//       return res
//         .status(400)
//         .json({ message: "No slot available for this day" });
//     }
...
//       const ruleStartDate = new Date(rule.date);
//       ruleStartDate.setHours(ruleStartH, ruleStartM, 0, 0);

//       const ruleEndDate = new Date(rule.date);
//       ruleEndDate.setHours(ruleEndH, ruleEndM, 0, 0);

//       if (startDate < ruleStartDate || startDate >= ruleEndDate) {
//         return res
//           .status(400)
//           .json({ message: "Selected time is outside available slot" });
//       }
//     }
